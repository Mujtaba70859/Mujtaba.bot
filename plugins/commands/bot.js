...
if ((event.body.toLowerCase() == "@Shayan BuTt") || (event.body.toLowerCase() == "Shayan Butt")) {
return api.sendMessage("️GG Bolo busy h wo 🙆:))))", threadID);
}; 
...
if ((event.body.toLowerCase() == "Ashu") || (event.body.toLowerCase() == "ashu")) {
return api.sendMessage("Shayan ki speical friend ❤️", threadID);
}; 
